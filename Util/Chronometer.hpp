...
class Chronometer{
    ...
    int getResultTime(int unity){
		...
		if(this->unity == this->NANOSECONDS_UNITY){
            ...
            if(unity == this->NANOSECONDS_UNITY) return (int) resultTime;
		...
		if(this->unity == this->MICROSECONDS_UNITY){
            ...
            if(unity == this->MICROSECONDS_UNITY) return (int) resultTime;
		...
		if(this->unity == this->MILLISECONDS_UNITY){
            ...
            if(unity == this->MILLISECONDS_UNITY) return (int) resultTime;
